...
- skills/typescript-core.md
- skills/javascript-core.md
- skills/python-core.md
- skills/go-core.md
...
- `skills/frontend/ui-engineering.md` — Framework-agnostic UI engineering guidance (accessibility, design system, responsive).
- `skills/frontend/react-ui.md` — React-specific UI patterns and invocation examples.
- `skills/frontend/preact-ui.md` — Preact-specific UI patterns and invocation examples.
- `skills/frontend/vue-ui.md` — Vue-specific UI patterns and invocation examples.
- `skills/frontend/ui-accessibility.md` — Repository WCAG 2.1 AA enforcement skill; invoke as final gating for any user-facing change.
